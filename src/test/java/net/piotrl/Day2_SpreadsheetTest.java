...
class Day2_SpreadsheetTest {
    ...
    void examplePart2() {
        ...
        verifyPart2(input, expectedResult);
    }

    @Test
    void fullExamplePart2() {
        String input = "4168\t3925\t858\t2203\t440\t185\t2886\t160\t1811\t4272\t4333\t2180\t174\t157\t361\t1555\n" +
                "150\t111\t188\t130\t98\t673\t408\t632\t771\t585\t191\t92\t622\t158\t537\t142\n" +
                "5785\t5174\t1304\t3369\t3891\t131\t141\t5781\t5543\t4919\t478\t6585\t116\t520\t673\t112\n" +
                "5900\t173\t5711\t236\t2920\t177\t3585\t4735\t2135\t2122\t5209\t265\t5889\t233\t4639\t5572\n" +
    ...
    private void verify(String input, int expectedResult) {
        Day2_Spreadsheet service = new Day2_Spreadsheet();
        int result = service.calcChecksum(input);
        assertEquals(expectedResult, result);
    }

    private void verifyPart2(String input, int expectedResult) {
        Day2_Spreadsheet service = new Day2_Spreadsheet();
        int result = service.calcChecksumEvenlyDistributed(input);
        assertEquals(expectedResult, result);
    }
