...
class Day4_PassphraseTest {

    @Test
    void valid1() {
        String input = "abcde fghij";
        Day4_Passphrase service = new Day4_Passphrase();
        assertEquals(service.correctPhrasesWithUniqueLetters(input).size(), 1);
    }
    ...
    void not_valid_2() {
        ...
        Day4_Passphrase service = new Day4_Passphrase();
        assertEquals(service.correctPhrasesWithUniqueLetters(input).size(), 0);
    }
    ...
    void fullPuzzle() {
        ...
        Day4_Passphrase service = new Day4_Passphrase();
        assertEquals(service.correctPhrases(input).size(), 451);
        assertEquals(service.correctPhrasesWithUniqueLetters(input).size(), 223);
    }
